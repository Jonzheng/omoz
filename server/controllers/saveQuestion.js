...
const que_sound = 'que_sound-1256378396'
const que_image = 'que_image-1256378396'
...
module.exports = async ctx => {
    ...
    var question_id = fields.question_id
    ...
    function upload_image() {
        ...
        var image_name = paper_id + "_" + type + "_" + question_id + ".png"
    ...
    function upload_sound() {
        ...
        var sound_name = paper_id + "_" + type + "_" + question_id + ".mp3"
        var params_sound = {
            Bucket: que_sound,
            Region: Region,
            ContentLength: file_image.size,
    ...
    //数据库参数
    var insert_values = [paper_id,question_id,title,option_a,option_b,option_c,option_d,right_option,an_explain,point,type,article,src_sound,src_image,uploader]
    ...
    function get_sql(params_lst) {
        var str_sql_ins = 'insert t_question (paper_id,question_id,title,option_a,option_b,option_c,option_d,right_option,an_explain,point,type,article,src_sound,src_image,uploader) values('
